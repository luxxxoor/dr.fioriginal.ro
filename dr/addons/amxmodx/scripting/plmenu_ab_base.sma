...
public CmdBanReason(id)
{
	...
	{
		client_cmd(id, "amx_banip #%i %i ^"%s^"", userid2, g_menuSettings[id] == 0 ? 9999 : g_menuSettings[id], reason);
	}
	else
	{
		client_cmd(id, "amx_ban #%i %i ^"%s^"", userid2, g_menuSettings[id] == 0 ? 9999 : g_menuSettings[id], reason);
	}
